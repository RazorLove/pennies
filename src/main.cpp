...
const string strMessageMagic = "Pennies Signed Message:\n";
...
// pennies: increasing Nfactor gradually
...
unsigned int ComputeMinWork(unsigned int nBase, int64 nTime)
{
    ...
    {
        // Maximum 200% adjustment per 48 hours...
        bnResult *= 2;
        nTime -= 48 * 60 * 60;
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in pennies
    bool fStrictPayToScriptHash = true; // Always active in pennies
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Pennies", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "ad divitem intrare spolia - Pennies, August 1, 2k13";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = nChainStartTime + 69;
        ...
        assert(block.hashMerkleRoot == uint256("0xf7ffaccb83f13c0a4dc8d852de2254da7b2b63623b38c0ad4afd1d606045f1f4"));
        block.print();
