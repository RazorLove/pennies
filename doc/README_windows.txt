...
Intro
-----
pennies is a free open source project derived from PPCoin, with
...
After completing windows setup then run windows command line (cmd)
  cd daemon
  penniesd
You would need to create a configuration file pennies.conf in the default
wallet directory. Grant access to penniesd.exe in anti-virus and firewall
...
penniesd backupwallet <destination_backup_file>
Then shutdown ppcoind by
penniesd stop
Start up the new penniesd (0.3.0).
